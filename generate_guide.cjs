...
3.  **Print Handovers**: Tap **Print / Export** to generate a compact, 1-page PDF of all active handovers to carry during rounds.\`
  ...
  {
    id: "09-pediatric-calculator",
    title: "9. Pediatric Drug Calculator",
    badge: "Clinical",
...
*Always cross-verify with local guidelines before administration.*\`
  ...
  {
    id: "10-quick-discharge",
    title: "10. Quick Discharge",
    badge: "Clinical",
    content: \`For patients who need a fast, standalone discharge summary without a full case workup — walk-ins with straightforward presentations, minor complaints — tap **Quick Discharge** from the dashboard instead of starting a full case. Paste notes, dictate, or scan a document; ErMate generates a complete discharge summary directly, skipping full case documentation. This feature is always free, regardless of subscription tier.\`
  },
  {
...
*   **Educational Insights**: After closing a real case, the Rounds & Debrief tab provides educational pearls based on the patient's presentation.\`
  ...
  {
    id: "12-em-reference",
    title: "12. Learn — EM Reference",
    badge: "Education",
    content: \`Tap **Learn** in the bottom navigation for instant, bedside-ready answers to clinical questions — dosing, protocols, differential considerations — referenced against standard emergency medicine sources (Tintinalli's, Rosen's, WikEM). Built for quick lookups during a shift, not lengthy reading — ask a focused question, get a focused answer.\`
  },
  {
    id: "13-rounds-debrief",
    title: "13. Rounds Debrief",
    badge: "Education",
    content: \`Inside a completed case, tap 🎓 **Rounds** to turn any real patient encounter into a teaching moment. Choose a debrief mode:
*   **First Principles** — pathophysiology from the ground up
*   **Devil's Advocate** — challenges your working diagnosis, surfaces what else it could have been
*   **Disease Snapshot** — a 2-minute structured reference card: what it is, pathophysiology, classic presentation, ER management, and the one thing that must not be missed
*   **Guidelines Review** — checks your management against current evidence-based recommendations
*   **Full Debrief** — all of the above in one structured pass
Useful for residents reviewing a shift with a senior, or for anyone who wants to turn today's case into tomorrow's sharper instinct.\`
  },
  {
    id: "14-hod-mode",
    title: "14. HOD Mode — Department Leadership",
    badge: "Core",
    content: \`If you're the Head of Department for your hospital, your dashboard shows an expanded view: department-wide case activity, team roster status, and pending approvals in one place.
### Your responsibilities as HOD:
*   **Approve or reject role-elevation requests** — when a resident requests to be recognized as Senior Consultant, it comes to you for review before it takes effect. Nobody can grant themselves an elevated role.
*   **Manage your Team Roster** — generate secure invite links for doctors joining your department, and approve their join requests.
*   **Confidential mortality/audit access** — M&M audit reviews are visible only to you and the reviewing physician, never the wider team.\`
  },
  {
    id: "15-doctors-directory",
    title: "15. Doctors Directory & Team Roster",
    badge: "Core",
    content: \`Two separate things, worth understanding the difference:
*   **Directory**: a self-reported listing of doctors by hospital — see who else has registered at your hospital. This is purely informational and grants no access to any patient data on its own.
*   **Team Roster**: your hospital's verified team — built through real invite links generated by your HOD, with each join request requiring HOD approval. This is what actually grants access to shared cases and handovers.

If no HOD exists yet for your hospital, the Directory shows a "Request to Lead This Department" option. This creates a pending request reviewed manually by ErMate's admin team before any leadership access is granted — a deliberate safeguard so department leadership can't be self-assigned by anyone who simply lists your hospital.\`
  },
  {
    id: "16-mortality-audit",
    title: "16. Mortality & M&M Audit",
    badge: "Clinical",
    content: \`For cases requiring a Mortality & Morbidity review, open the case and select **M&M Audit**. This generates a structured audit document covering cause-of-death classification and a preventability assessment, formatted to your hospital's quality-review standards.

Access is HOD-only and strictly confidential — no other team member can view a mortality audit unless specifically granted access by the HOD. Completed audits export as downloadable documents for departmental quality review meetings.\`
  },
  {
    id: "17-privacy-security",
    title: "17. Privacy, DPDP Act & Security",
    badge: "Core",
...
*   **No Training**: Your clinical data is never used to train ErMate's AI models.\`
  ...
  {
    id: "18-display-export",
    title: "18. Display Modes & Exports",
    badge: "Nav",
