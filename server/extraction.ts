...
`;
  ...
  try {
    ...
    if (!parsed?.differentials) {
      throw new Error("No differentials generated by Claude Sonnet engine.");
    }
    ...
    return {
      success: false,
      error: "Claude Sonnet clinical decision engine is currently unavailable. Please check your API key or try again shortly.",
    };
  }
}
