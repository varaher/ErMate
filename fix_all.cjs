...
const regex = /<h2 className="text-xs font-black text-slate-400 uppercase tracking-widest font-mono">[\s\S]*?\{\/\* Pending Cases Alert Board \*\/\}/;

const replacement = `<h2 className="text-xs font-black text-slate-400 uppercase tracking-widest font-mono">
          Clinical Tools & Active Workflows
        </h2>

        {/* Mobile Minimalist Action Pad (Visible on Mobile only) */}
        <div className="grid grid-cols-2 gap-3 md:hidden">
          {/* Card 3: Voice Scribe Desk (Assistant) */}
          <button 
