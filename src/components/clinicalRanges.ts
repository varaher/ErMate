 ...
 * Used by alertCompiler.ts and handover/discharge/mortality-audit/case-sheet
 * post-processing and UI rendering to flag abnormal values with `isAbnormal: true`
 * or `⚠️` flag suffixes.
 */
...
export const CLINICAL_RANGES: Record<ClinicalParam, Range> = {
  ...
  grbs:      { low: 70,   high: 180 },                // mg/dL (random/ER context)
