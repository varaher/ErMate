  ...
  return (
    <CollapsibleSection icon={<span>A</span>} iconBgColor="bg-red-600" title="Airway" titleColor="text-red-400" defaultOpen>
      <div className="space-y-4">
        <div>
          <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">Cry</label>
        ...
        <div>
          <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">Airway Status</label>
        ...
        <div>
          <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">Intervention</label>
          <div className="flex gap-2">
            <textarea value={state.intervention} onChange={(e) => onChange({ ...state, intervention: e.target.value })}
              ...
              className="flex-1 w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl px-3 py-2.5 text-slate-800 dark:text-white text-sm min-h-[70px]" />
  ...
  return (
    <CollapsibleSection icon={<span>B</span>} iconBgColor="bg-orange-500" title="Breathing" titleColor="text-orange-400" defaultOpen>
      <div className="space-y-4">
        ...
        <div>
          <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">Air Entry</label>
        ...
        <div>
          <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">Subcutaneous Emphysema</label>
...
export function PediatricCirculationSection({
  ...
  return (
    <CollapsibleSection icon={<span>C</span>} iconBgColor="bg-rose-600" title="Circulation of Skin" titleColor="text-rose-400" defaultOpen>
      <div className="space-y-4">
        <div>
          <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">Capillary Refill Time (CRT)</label>
        ...
        <div>
          <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">Skin Colour and Temperature</label>
        ...
        <div>
          <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">Distended Neck Veins</label>
...
export function PediatricDisabilitySection({
  ...
  return (
    <CollapsibleSection icon={<span>D</span>} iconBgColor="bg-amber-500" title="Disability" titleColor="text-amber-400" defaultOpen>
      <div className="space-y-4">
        <div>
          <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">AVPU / GCS</label>
        ...
        <div>
          <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">Pupils: Size and Response</label>
          <input value={state.pupils} onChange={(e) => onChange({ ...state, pupils: e.target.value })}
            placeholder="Equal, round, reactive to light"
            className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl px-3 py-2.5 text-slate-800 dark:text-white text-sm" />
        </div>
        <div>
          <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">Abnormal Responses</label>
          <div className="flex gap-2">
        ...
        <div>
          <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">Glucose (GRBS)</label>
    ...
    <>
      <CollapsibleSection icon={<span>E</span>} iconBgColor="bg-blue-500" title="Exposure" titleColor="text-blue-400" defaultOpen>
        <div className="space-y-4">
          ...
          />
          <div>
            <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">Evidence of Infection or Bleeding</label>
            <div className="flex gap-2">
              <textarea value={state.infectionBleedingEvidence} onChange={(e) => onChange({ ...state, infectionBleedingEvidence: e.target.value })}
                ...
                className="flex-1 w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl px-3 py-2.5 text-slate-800 dark:text-white text-sm min-h-[60px]" />
          ...
          <div>
            <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">Long Bone Deformities</label>
      ...
      <CollapsibleSection icon={<span>+</span>} iconBgColor="bg-slate-600" title="Extremities" titleColor="text-slate-300">
        <div className="space-y-4">
          <div>
            <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">Findings</label>
            <div className="flex gap-2">
          ...
          <div>
            <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">Immobilization</label>
  ...
  return (
    <CollapsibleSection icon={<span>🩻</span>} iconBgColor="bg-purple-600" title="Adjunct: EFAST (If Trauma Suspected)" titleColor="text-purple-400">
      <div className="space-y-4">
        {fields.map((f) => (
          <div key={f.key}>
            <label className="text-slate-800 dark:text-white text-sm font-semibold block">{f.label}</label>
    ...
    <CollapsibleSection icon={<span>👁</span>} iconBgColor="bg-indigo-600" title="General Examination" titleColor="text-indigo-400" defaultOpen>
      <div className="grid grid-cols-2 gap-3">
        {GENERAL_EXAM_LABELS.map(({ key, label }) => (
          <div key={key} className="flex items-center justify-between bg-white dark:bg-slate-900 rounded-xl px-3 py-2.5">
...
export function PediatricQuickNormalPresets({ onApply, onFillAll }: PediatricQuickPresetsProps) {
  ...
  return (
    <div className="bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 space-y-3">
      <div>
        <p className="text-slate-800 dark:text-white font-bold text-sm">QUICK NORMAL PRESETS (Pediatric)</p>
      ...
      <div className="flex flex-wrap gap-2">
        {sections.map(({ key, label }) => (
          <button
            ...
            className="px-3 py-1.5 bg-slate-200 dark:bg-slate-800 hover:bg-slate-300 dark:hover:bg-slate-700 text-slate-800 dark:text-white text-xs font-semibold rounded-lg transition-colors"
          >
            {label}
          </button>
        ))}
        <button
          type="button"
          onClick={onFillAll}
          className="px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-slate-800 dark:text-white text-xs font-bold rounded-lg transition-colors"
        >
...
export function PediatricDispositionSection({
  ...
  return (
    <CollapsibleSection icon={<span>📋</span>} iconBgColor="bg-emerald-600" title="Disposition" titleColor="text-emerald-400" defaultOpen>
      <div className="space-y-4">
        <div>
          <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">Provisional Diagnosis at the Time of Discharge/Shift</label>
          <div className="flex gap-2">
        ...
        <div>
          <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">Condition at the Time of Shift</label>
        ...
        <div>
          <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">Disposition</label>
        ...
        <div>
          <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">Differential Diagnosis</label>
          <div className="flex gap-2">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">EM Resident</label>
            <input value={state.emResident} onChange={(e) => onChange({ ...state, emResident: e.target.value })}
              className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl px-3 py-2.5 text-slate-800 dark:text-white text-sm" />
          </div>
          <div>
            <label className="text-slate-800 dark:text-white text-sm font-semibold block mb-1.5">EM Consultant</label>
